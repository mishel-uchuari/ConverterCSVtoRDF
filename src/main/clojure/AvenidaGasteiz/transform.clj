...
(def base-Etilbenceno (base-element "Etilbenceno(µg/m3)"))
(def base-NO (base-element "NO(µg/m3)"))
(def base-NO2 (base-element "NO2(µg/m3)"))
(def base-NOX (base-element "NOX(µg/m3)"))
(def base-Ortoxileno (base-element "Ortoxileno(µg/m3)"))
(def base-PM10 (base-element "PM10(µg/m3)"))
(def base-PM25 (base-element "PM25(µg/m3)"))
(def base-Tolueno (base-element "Tolueno(µg/m3)"))
